...
export function BeginnerSplitFemale() {
  ...
  export function AdvancedSplitFemale() {
    ...
    const HandleSaveClickPushPullGlutes = async () => { // handles saving of the users choice of split when picked!
      if (userId) {
        const data = {
          split: "Push Pull + Glutes",
          updatedAt: Timestamp.now(),
        };
    ...
    const HandleSaveClickUpperLowerLegs = async () => { // handles saving of the users choice of split when picked!
      if (userId) {
        const data = {
          split: "Upper Lower + Legs",
          updatedAt: Timestamp.now(),
        };
    ...
    return (
      <div>
        ...
        <ul>
          ...
          <Button onClick={() => {handleShowTrainingGoal(fullscreen); HandleSaveClickPushPullGlutes();}}>
            <div>
              <p>Recomended: Push Pull + Glutes</p>
              <p>Time: 5 Day</p>
            </div>
          </Button>
          <Button onClick={() => {handleShowTrainingGoal(fullscreen); HandleSaveClickUpperLowerLegs();}}>
            <div>
